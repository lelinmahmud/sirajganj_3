...
public class VerifyPhoneActivity extends AppCompatActivity {
    ...
    private void verifyVerificationCode(String code) {
        ...
        if (mVerificationId != null) {
            ...
            Log.d(TAG, "verifyVerificationCode: Empty Verification ID");
        }
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onVerificationCompleted(PhoneAuthCredential phoneAuthCredential) {
            ...
            Log.d(TAG, "onVerificationCompleted: onVerificationCompleted");
        }

        @Override
        public void onVerificationFailed(FirebaseException e) {
            Toast.makeText(VerifyPhoneActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
            Log.d(TAG, "onVerificationFailed: onVerificationFailed" + e.getMessage());
        }
        ...
        public void onCodeSent(@NotNull String s, @NotNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
            ...
            Log.d(TAG, "onVerificationCompleted: onCodeSent " + mVerificationId);
        }
    };
